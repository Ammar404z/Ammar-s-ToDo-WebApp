...
- [x] (11 / 11 Punkte) View zur Verwaltung von `ToDos`
  ...
  - [x] (2 Punkte) View-Elemente für `POST /todos` - description und due date sollten optional sein
...
- [x] (1 Punkt) Terminologie, Farben und Layout sind konsistent - Todo mit langer description sieht nicht gut aus
